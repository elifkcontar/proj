...
test=generate_data(directory='/home/ekcontar/dat/', augmentation=False, shuffle=False, batch_size=10, file_list=test_id, label_1=test_label_c)
...
load_model.load_weights("class.h5")
