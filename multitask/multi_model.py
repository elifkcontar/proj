...
train=generate_data(directory='/home/ekcontar/dat/', augmentation=True, shuffle=True, batch_size=10, file_list=train_id, label_1=train_label_c, label_2=train_label_a, mask=train_mask)

validation=generate_data(directory='/home/ekcontar/dat/', augmentation=False, shuffle=True, batch_size=10, file_list=valid_id, label_1=valid_label_c, label_2=valid_label_a, mask=valid_mask)
...
with open("mu.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("mu.h5")
print("Saved first model to disk")


#Second part, train model with all layers
#Load model
json_file = open('mu.json', 'r')
model_json = json_file.read()
json_file.close()
model = model_from_json(model_json)
#Load weights into new model
model.load_weights("mu.h5")
